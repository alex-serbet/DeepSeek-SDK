...
public class DeepSeekClient : IDisposable
{
    ...
    /// </summary>
    public event EventHandler<Usage>? OnTokenUsage;
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var assistantMessage = new ChatMessage { Role = result.Role, Content = result.Content };
    ...
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>The chat result</returns>
    public async Task<ChatResult> SendMessageOnceAsync(
        string message,
        bool stream = true,
        CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>The chat result</returns>
    public async Task<ChatResult> SendMessagesAsync(
    ...
    /// </summary>
    public async Task<ChatResult> SendMessageWithDebugAsync(
        string message,
        bool stream = true,
        CancellationToken cancellationToken = default)
    {
    ...
    private async Task<ChatResult> ProcessStreamResponseAsync(
        HttpResponseMessage response,
        CancellationToken cancellationToken)
    {
        var result = new ChatResult { WasStreamed = true };
        ...
        while ((line = await reader.ReadLineAsync(cancellationToken)) != null)
        {
            ...
            if (line.StartsWith("data: "))
            {
                ...
                try
                {
                    var chatResponse = JsonSerializer.Deserialize<ChatResponse>(data);
    ...
    private async Task<ChatResult> ProcessRegularResponseAsync(
        HttpResponseMessage response,
        CancellationToken cancellationToken)
    {
        ...
        return new ChatResult { Content = string.Empty };
    }
